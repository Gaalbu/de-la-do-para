...
| C25 — especificação de inventário | `specs/SPEC-inventory.md`, D11/D13/D27/D54/D66/D67 | `docs:check`, `git diff --check`, revisão humana da spec; implementação/testes em C26/C57 | branch `docs/c24a-logistics-decisions`, proposta ainda não commitada | Vocabulário de saldos, reserva de 15 minutos, elegibilidade por chegada, fixture sintética e INV-001–008 documentados; FEFO/bloqueio ativo/calendário anual ainda abertos; não concluído |
