...
| C26 — invariantes de lote | `backend/src/main/java/br/com/deladopara/inventory/domain`, `backend/src/test/java/br/com/deladopara/inventory/domain` | `InventoryLotTest`, backend `verify`, CI 7/7 | `0dba72c` | Saldos, margem D67, bloqueio e artesanato sem validade; PR #39 aberta e mergeable; FEFO e alocação permanecem abertos |
