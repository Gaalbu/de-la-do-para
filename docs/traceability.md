...
| C24 — imagem principal de produto | `specs/SPEC-media.md`, ADR 0006 | Backend verify, contrato, docs/security/frontend gate e `aislop` | PR #36, `feat/c24-media`, empilhada sobre PR #35 | Commit `1d5b2ac`; usuário aprovou uma imagem principal por produto, JPEG/PNG e limite de 5 MiB; `CatalogMediaApiIT` cobre substituição, falhas, 413, estado público, remoção, 401/403 e CSRF; verificações locais aprovadas; CI `35655927076` 7/7 verde; PR MERGEABLE/CLEAN e aberta |
