...
| C24 — imagem principal de produto | `specs/SPEC-media.md`, ADR 0006 | Backend verify, contrato, docs/security/frontend gate e `aislop` | PR C24 será empilhada sobre PR #35 | Usuário aprovou uma imagem principal por produto, JPEG/PNG e limite de 5 MiB; `CatalogMediaApiIT` cobre substituição, falhas, 413, estado público, remoção, 401/403 e CSRF; processamento/armazenamento, Angular e Playwright verificados localmente; CI remoto pendente |
