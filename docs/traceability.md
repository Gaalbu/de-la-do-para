...
| Plano C30/C31 | `tasks/plan.md`, `specs/SPEC-pricing.md` | revisão de dependências e checkpoints; implementação futura | commit desta atualização | Ordem C30 → C31, testes BT/BI, gates e bloqueios de contador global documentados; nenhum código novo |
